    ...
    <el-row class='list-box' v-loading='loading' element-loading-spinner="el-icon-loading" element-loading-text="loading....">
      <!--<el-col :span='24'>-->
        <!--<div>-->
          <!--<el-steps class="steps-common" finish-status="process" :active='active-1' simple>-->
            ...
            <!--<el-step title='Train Model' icon='icon-lock'></el-step>-->
          <!--</el-steps>-->
        <!--</div>-->
      <!--</el-col>-->
      ...
      <el-col :span='24'>
        <el-steps :active="active" finish-status="success" simple>
          <el-step title='Select Pre-trained Model'></el-step>
          <el-step title='Train Model'></el-step>
        </el-steps>
      </el-col>
        ...
        <el-form ref='form' size='small' :model='form' :rules='rules' label-width='200px'>
          ...
          <div class='step-box' v-if="active == 1">
            ...
            <el-form-item prop='attribute' label='Architecture' v-if='noAttribute'>
              <el-input disabled=disabled size='small' placeholder="The 'Solution' is not 'Architecture'. Please re-select it."></el-input>
            </el-form-item>
            ...
            <el-form-item prop='model' label='Pre-trained Model' v-if='noModel'>
              <el-input disabled=disabled size='small' placeholder="The 'Architecture' is not 'Pre-trained Model'. Please re-select it."></el-input>
            </el-form-item>
          ...
          <div class="step-box" v-if='active == 2'>
            <el-col :span='24'>
              ...
              <el-form-item v-if='active == 2'>
                ...
                <!--</div>-->
                <div class="step-action-create" v-if="trainStart == false && trainOK == false">
                  <div class="pt15"></div>
                  <el-button class="" style="margin-left:22px" size='small' @click="active--" v-if="active != 1">
                    <!--<i class='icon-arrow-left13'></i>-->
                    &lt; back</el-button>
                  <el-button class="" size='small' type="primary" @click="submitForm('form', 'All')">Create and Train &gt;
          ...
          <el-col :span="24">
          <el-form-item class='item-button' v-if='active == 1'>
          ...
          <el-col class="training-container" :span='24' v-if='trainStart'>
            <el-collapse class="active-name-2" v-model='activeNames'>
              <el-collapse-item name='2'>
                ...
                <div class="box random-btn-wrap">
                  <el-button class="train-sta common-btn" :disabled="trainOK ? false : true" size="small" @click="dialogTableVisible = true">Training Statistics</el-button>
                  <el-button class="train-down common-btn" size="small" :disabled="trainOK ? false : true" @click="download('https://eiq-cloud.s3.amazonaws.com/'+trainingRes.t_full_log_url)" type="primary">Download Full Log</el-button>
                  <div class="status-container" v-if="trainStart && trainOK == false">
                    ...
                    <div v-else-if="state === 'ready'" class="ready-for-training">
                      <span class="fl" style="margin-right: 10px" type='info' :loading="true" size="small">Ready for training, please wait a moment...</span>
                    </div>
                    <div v-else-if="state === 'pack'">
                      <el-button class="fl" style="margin-right: 10px" type='info' :loading="true" size="small">Packing in progress, please wait a moment...</el-button>
                    </div>
                    <div v-else class="fl">
                    ...
                    <div class="random-btn-wrap fl">
                      <el-button class="train-down common-btn" size="small" type="danger" @click="stopTrain">Stop training</el-button>
                    </div>
                    <div class="fl tip">In training, please do not refresh the page!</div>
                  </div>
                  <div v-if="trainStart && trainOK">
                    <el-button class="common-btn" type="success" size="small" @click="download('https://eiq-cloud.s3.amazonaws.com/'+trainingRes.model_url)">Training completed! To download</el-button>
                  </div>
                </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      Create (params) {
        console.log(params)
        eiqDetail('post', 'model', params).then(json => {
      ...
      getTraEngine () {
        ...
        thisVue.params.is_dl_framework = true
...
<style scoped>
  ...
  .status-container{ margin-left: 0;float: left;margin-top: 0px;}
  .status-container .ready-for-training{ float:left;line-height: 32px;}
  ...
  .page-filter-s{ float: left; width: 101px; padding-right: 0;}
</style>
<style>
